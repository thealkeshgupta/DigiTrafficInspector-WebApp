...
var currentVehicle = document.getElementById("vid").getAttribute("name");
console.log(currentVehicle+"abcccc")
db.collection("Complaints").where("VEHICLE_NUMBER", "==", currentVehicle)
    .get()
    ...
    db.collection("Complaints2").where("VEHICLE_NUMBER", "==", currentVehicle)
    .get()
    .then(function(querySnapshot) {
        querySnapshot.forEach(function(doc) {
            // doc.data() is never undefined for query doc snapshots
